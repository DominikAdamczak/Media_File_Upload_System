...
describe('ApiClient (Mobile)', () => {
  ...
  describe('setBaseURL', () => {
    it('should update base URL', () => {
      const newUrl = 'http://192.168.1.100:8000/api';
  ...
  describe('uploadChunk', () => {
    it('should upload chunk successfully with Blob', async () => {
      const mockResponse = {
        data: {
          success: true,
    ...
    it('should upload chunk successfully with FormData', async () => {
      const mockResponse = {
        data: {
          success: true,
          message: 'Chunk uploaded',
      ...
      const result = await apiClient.uploadChunk('upload-id', 0, formData);
